...
<main role="main" class="container">
    ...
    <form action="guardarform.php" method="post" class="form-register" >
        ...
        <div class="contenedor-inputs">
            ...
            <input type="text" name="email" placeholder="E-mail" class="input-500" required>
            <?php
            if($correcto == 1){?>
                <div id="anuncio" class="alert alert-success"> ¡El usuario ha sido registrado correctamente!</div>
                <?php $correcto=0; }?>
            <?php
            if($repetido == 1){?>
