<?php
          ...
          try {
              ...
              $nuevo = $hora.$puntos.$minutos.$puntos.$segundos;
               ...
               $sql =  "INSERT INTO `records` (`id_record`,`id_rutina` ,`id_tipo_record`, `id_unidad_puntos`, `repeticiones_puntos`, `id_unidad_peso`, `peso`, `tiempo`, `fecha_creacion`, `id_usuario`, `id_clase`) VALUES (NULL,'{$wod}','{$tipo}',NULL, '{$repeticiones}', '{$unidad_peso}', '{$peso_record}', '{$nuevo}','{$fecha_record}','{$id}', NULL)";
