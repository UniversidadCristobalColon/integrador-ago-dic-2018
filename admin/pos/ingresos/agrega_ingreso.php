...
<main role="main" class="container">
    ...
    <div class="starter-template">
        <h1>Nuevo ingreso</h1>
        <p class="lead">
        <form action="nuevo_ing.php" method="post">
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    ...
                    <input type="text" name="cliente" class="form-control" id="inputMonto" placeholder="1" required>
                </div>
                <div class="col-md-3">
                    <label for="inputMonto">Cantidad: </label>
                    <input type="text" name="cantidad" class="form-control" id="inputMonto" placeholder="1" required>
                </div>
            </div>
        </form>
        </p>
