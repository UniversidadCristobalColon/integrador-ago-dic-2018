<?php
          ...
          try {
              ...
              $sql = "UPDATE `usuarios` SET `correo` = '{$correo}', `nombre_completo` = '{$nombre_completo}',`nombre_corto` = '{$nombre_corto}', `telefono` = '{$telefono}',`celular` = '{$celular}',  `nombre_emergencia` = '{$nombre_emergencia}', `telefono_emergencia` = '{$telefono_emergencia}',`id_usuario_modificacion`= '{$_SESSION["id_usuario"]}',`fecha_modificacion`= NOW() WHERE `id_usuario` = '{$id}' ";
              echo $sql;
